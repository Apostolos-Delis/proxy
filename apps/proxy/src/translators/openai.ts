...
function parseJsonData(frame: SseFrame) {
  try {
...
function formatFrame(frame: SseFrame) {
  const lines = [];
...
function eventType(event: Record<string, unknown>, frame: SseFrame) {
...
function firstChoice(choices: unknown) {
