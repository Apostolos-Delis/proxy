import { GATEWAY_MODEL_ENDPOINTS, type HarnessCompatibilityProfileId } from "@proxy/schema";
  ...
  profiles: [
    {
      ...
      transport: "http",
      endpoints: [GATEWAY_MODEL_ENDPOINTS.responsesHttp.path],
    ...
    },
    {
      ...
      dialect: "openai-responses",
      transport: "websocket",
      endpoints: [GATEWAY_MODEL_ENDPOINTS.responsesWebsocket.path],
  ...
  profiles: [
    {
      ...
      transport: "http",
      endpoints: [GATEWAY_MODEL_ENDPOINTS.messages.path],
  ...
  profiles: [
    {
      ...
      dialect: "openai-chat",
      transport: "http",
      endpoints: [GATEWAY_MODEL_ENDPOINTS.chatCompletions.path],
