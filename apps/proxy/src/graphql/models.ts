...
export type PromptCachePrewarmReportModel = Awaited<ReturnType<Q["promptCachePrewarms"]>>;
export type PromptCachePrewarmJobRowModel = PromptCachePrewarmReportModel["jobs"][number];
