...
const operations: Operation[] = [
  ...
  { name: "settings", query: "query { settings { organizationId databaseEnabled settings { schemaVersion cacheTtlUpgrade automaticCaching toolResultCompression duplicateToolResultReferences costBaseline { anthropicMessagesModel openaiResponsesModel openaiChatModel } classifier { model } routeQuality { lowConfidenceThreshold } promptCapture { promptCaptureMode retentionDays } } } }" },
