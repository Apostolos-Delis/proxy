...
const documents: Documents = {
    ...
    "\n  query CompressionPreviewPanel($input: CompressionPreviewInput!) {\n    compressionPreview(input: $input) {\n      contentAvailable\n      contentRedactionReason\n      blocks\n      savedBytes\n      savedTokens\n      previewBlocks {\n        blockPath\n        toolName\n        ruleId\n        status\n        skipReason\n        originalBytes\n        compressedBytes\n        savedTokens\n        diffSegments {\n          side\n          text\n        }\n      }\n    }\n  }\n": types.CompressionPreviewPanelDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query CompressionPreviewPanel($input: CompressionPreviewInput!) {\n    compressionPreview(input: $input) {\n      contentAvailable\n      contentRedactionReason\n      blocks\n      savedBytes\n      savedTokens\n      previewBlocks {\n        blockPath\n        toolName\n        ruleId\n        status\n        skipReason\n        originalBytes\n        compressedBytes\n        savedTokens\n        diffSegments {\n          side\n          text\n        }\n      }\n    }\n  }\n"): typeof import('./graphql').CompressionPreviewPanelDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query ProviderCredentialOAuthStatus($loginId: ID!) {\n    providerCredentialOAuthStatus(loginId: $loginId) {\n      loginId\n      status\n      providerAccountId\n      error\n    }\n  }\n"): typeof import('./graphql').ProviderCredentialOAuthStatusDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
