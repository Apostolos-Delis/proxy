...
// MenuSelect with a filter input on top — for option lists long enough that
// scanning beats scrolling (e.g. picking a provider key).
export function SearchSelect({ value, options, ariaLabel, placeholder = "Search…", className = "", onChange }: SearchSelectProps) {
