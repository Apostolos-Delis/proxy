...
Proxy is an OpenAI/Anthropic-compatible model routing gateway with durable event and usage capture. The repo is organized for agentic engineering: durable decisions live in docs, transport boundaries stay thin, and provider-specific behavior stays behind adapters.
